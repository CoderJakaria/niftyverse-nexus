      ...
      <div className="max-w-5xl lg:mx-auto mx-3 flex items-center justify-between">
        <Link to="/">
          <div className="flex items-center">
            ...
            />
            <h3 className="sm:block hidden text-[30px] ml-2 font-normal text-black">
              Niftyverse
            </h3>
          </div>
        </Link>
        ...
        <div className="flex items-center space-x-5">
          <div className="flex items-center justify-between bg-white rounded-[40px] border border-gray-300 px-3 py-1">
            <input
              type="text"
